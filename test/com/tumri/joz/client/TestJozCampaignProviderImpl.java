...
public class TestJozCampaignProviderImpl extends TestCase {
    private static String host = "tcm-prod.dc1.tumri.net";
...
//            jozServerThread.start();
           provider = new JozDataProviderImpl(host, 2544,10,numRetries);
        } catch (Exception e) {
    ...
    public void testCampaignAdd() {
    	try {
			...
			campaign.setName("ScottTestCampaign");
