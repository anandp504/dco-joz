...
public class TransientDataManagerTest {
    ...
    public void testTspecAdd() {
        ...
        String tSpecAddStr3 = "(t-spec-add :name ' |" + sampleTSpecName3 + "| :version -1 :include-categories '(|GLASSVIEW.TUMRI_14215| |GLASSVIEW.TUMRI_14209| |GLASSVIEW.TUMRI_14208| |GLASSVIEW.TUMRI_14214| |GLASSVIEW.TUMRI_14217| |GLASSVIEW.TUMRI_14227| ) :ref-price-constraints '(10.0 146.0) )";
        ...
        String[] tspecNameArray = {sampleTSpecName, sampleTSpecName2, sampleTSpecName3, sampleTSpecName4};
        String[] strArray = {tSpecAddStr, tSpecAddStr2, tSpecAddStr3, tSpecAddStr4};
