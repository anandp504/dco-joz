...
<%
	...
	String prodInfo = request.getParameter("selProducts");
	if (prodInfo == null){
		prodInfo = (String)session.getAttribute("selProducts");
	} else {
		session.setAttribute("selProducts", prodInfo);
	}
...
<div id="productattr" style="text-align: left">
	<p>Select product attributes for display:&nbsp;&nbsp;&nbsp;
		...
		<input id="deSelectAll" name="selectAll" type="radio" onClick="javascript:selAllAttr(0);"/>De-select All
	</p>
	<table>
		<tr>
...
<tr style="text-align: center">
	<td>
		<br>
		Products for the given OSpec and Tspec combination (<%=tp%> products found):
