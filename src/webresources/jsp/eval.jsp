...
<div>
    ...
    (":" + JozAdRequest.KEY_T_SPEC)%> <%=(":" + JozAdRequest.KEY_URL)%> <%=(":" + JozAdRequest.KEY_WHICH_ROW)%> <%=(":" + JozAdRequest.KEY_ZIP_CODE)%>  <%=(":" + JozAdRequest.KEY_EXTERNAL_PAGE_ID)%> <%=(":" + JozAdRequest.KEY_USER_BUCKET)%>
        )
    </i>
</div>
<br>
