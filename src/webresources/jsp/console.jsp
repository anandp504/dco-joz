...
<div>
    <a href="/joz/console?mode=optContentStatus">Opt Content status</a>
</div>
<br>
...
<div>
    <a href="http://<%=request.getServerName()%>:<%=request.getServerPort()%>/joz/refresh?type=listingOpt"
       onclick="return confirm('This will force a Listing Optimized data refresh. Do you want to continue?');">Refresh ListingOpt Data</a>
</div>
<br>
