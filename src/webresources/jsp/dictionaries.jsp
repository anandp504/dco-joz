...
<head>
    ...
    <title>Joz Console : DictionaryManager Inspector joz</title>
</head>
<body>
<%
    ...
    if (indexName != null) {
        if (!"kId".equalsIgnoreCase(indexName)) {
            com.tumri.utils.dictionary.Dictionary d = (Dictionary) com.tumri.joz.index.DictionaryManager.getInstance().getDictionary(IProduct.Attribute.valueOf(indexName));
            if (d != null) {
                results = d.getValues();
            }
        }
    }
    IProduct.Attribute[] jozAttrs = IProduct.Attribute.values();
%>
...
<div id="links">
    <strong>Joz's dictionary manager</strong>
</div>
<br>

<form id="ProdSelForm" action="/joz/jsp/dictionaries.jsp" method="post">
    <table cellpadding="5">
        <tr align="center">
        ...
        <tr align="center">
            <td>
                <select id="IndexName" name="IndexName">
                    <%
                        for (IProduct.Attribute attr : jozAttrs) {
                            String attrName = attr.name();
                            if (attrName == null || "kId".equalsIgnoreCase(attrName)) {
                                continue;
                            }
                            String selected = "";
                            ...
                            com.tumri.utils.dictionary.Dictionary d = (Dictionary) com.tumri.joz.index.DictionaryManager.getInstance().getDictionary(IProduct.Attribute.valueOf(attrName));
                            if (d != null) {
                                List l = d.getValues();
                                if (l != null) {
