...
public class TmpMappingDB implements MappingDB {
    ...
    TmpMappingDB(String mapping_path) throws FileNotFoundException,
            IOException, BadMappingDataException {
        init(mapping_path);
    }
    ...
    public void add(String kind, String domain, String t_spec_name,
        ...
        if (kind.equalsIgnoreCase(":realm")) {
            ...
            mol.add(new MappingObj(MappingObj.MappingType.URL, fweight,
                    modified, t_spec_name));
            ...
            mol.add(new MappingObj(MappingObj.MappingType.THEME, fweight,
                    modified, t_spec_name));
            ...
            mol.add(new MappingObj(MappingObj.MappingType.STORE_ID, fweight,
                    modified, t_spec_name));
        }
    }
    
    public void delete(String kind, String domain, String t_spec_name,
            Long mod_time) {
        MappingObjList mol;
    ...
    private void init(String mapping_path) throws FileNotFoundException,
            IOException, BadMappingDataException {
        log.info("Loading mapping products from " + mapping_path);
        load_mappings_from_lisp_file(mapping_path);
    }
    
    private void load_mappings_from_lisp_file(String mapping_path)
    ...
    private static long date_string_to_int(String date) {
        return 42; // FIXME
    }
}
