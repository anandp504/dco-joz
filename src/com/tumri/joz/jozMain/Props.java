...
public class Props {
    ...
    public static int get_monitor_port() {
        if (monitor_port == -1)
            monitor_port = get_int_property(MONITOR_PORT, DEFAULT_MONITOR_PORT);
        return monitor_port;
    }
    
    public static String get_joz_version() {
        if (joz_version == null)
    ...
    public static void init(String config_dir, String config_file,
        ...
        if (empty_p(config_dir)) {
            ...
            // non-/ file systems.
            if (config_dir.endsWith("/") || config_dir.endsWith(File.separator)) {
    ...
    private static void read_properties(Properties props, String path) {
    ...
    private static void find_host_name() {
        try {
    ...
    private static int get_int_property(String name, int default_value) {
        try {
    ...
    private static boolean empty_p(String s) {
