...
public abstract class Command {
    ...
    public static Command parse(String cmd) throws BadCommandException {
        ...
        try {
            ...
            if (!e.isSexpList())
                throw new BadCommandException("not an expression: "
                        + e.toString());
            ...
            if (!cmd_expr.isSexpSymbol())
                throw new BadCommandException("command name not a symbol: "
                        + cmd_expr.toString());
