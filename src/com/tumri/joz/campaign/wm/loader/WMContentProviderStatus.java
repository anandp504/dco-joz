 ...
 */
public class WMContentProviderStatus {
    ...
    public LinkedList<WMContentProviderStatusHistory> runHistory = new LinkedList<WMContentProviderStatusHistory>();

    private static int MAX_HISTORY = 24;

    private static WMContentProviderStatus g_instance = null;

	private WMContentProviderStatus() {
		super();
	}
	 ...
	 * @return
	 */
	public static WMContentProviderStatus getInstance() {
		if (g_instance == null) {
			g_instance =  new WMContentProviderStatus();
		}
		return g_instance;
	}

    public void addRunHistory(long refreshTime, boolean runStatus, String runDetail) {
        WMContentProviderStatusHistory hist = new WMContentProviderStatusHistory();
    ...
    public String toString() {
        ...
        if (runHistory != null && runHistory.size() > 0) {
           for (WMContentProviderStatusHistory hist : runHistory) {
   ...
   public class WMContentProviderStatusHistory {
