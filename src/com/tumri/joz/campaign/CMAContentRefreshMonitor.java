...
public class CMAContentRefreshMonitor implements PollingUnit {
    ...
    public void loadCampaignData() {
        try {
            ...
            CMAContentProviderStatus.getInstance().addRunHistory(startTime, true, "Force Refresh successful." +
            ...
            CMAContentProviderStatus.getInstance().addRunHistory(errTime, false, "Refresh Failed. " +
                    " Details : " + errorDetails.toString());
            CMAContentProviderStatus.getInstance().lastError = e;
            CMAContentProviderStatus.getInstance().lastErrorRunTime = errTime;
            CMAContentProviderStatus.getInstance().lastRunStatus = false;
            CMAContentProviderStatus.getInstance().lastRefreshTime = errTime;
