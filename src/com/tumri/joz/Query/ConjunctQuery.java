...
public class ConjunctQuery implements Query, Cloneable {
	...
	public SortedSet<Handle> exec() {
		...
		SetIntersector<Handle> intersector =
				(isScan() ? m_queryProcessor.buildTableScanner(m_queries, m_reference, isStrict()) : m_queryProcessor.buildIntersector(m_queries, m_reference, isStrict(), isUseTopK(), getM_alpha()));
