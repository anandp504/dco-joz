...
public class ProductQueryProcessor extends QueryProcessor {
	 ...
	 */
	public SetIntersector<Handle> buildIntersector(ArrayList<SimpleQuery> aQueries, Handle reference, boolean isStrict, boolean isTopK, double alpha) {
		ProductSetIntersector aIntersector = new ProductSetIntersector(isStrict);
		aIntersector.setAlpha(alpha);
